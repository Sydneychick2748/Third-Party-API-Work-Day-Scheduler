...
tThis project is a daily planner for people with busy schedules to keep up with all their tasks for the hours of the day.
 With a busy schedule, I want to add important events to a daily planner so I can manage my time effectively. You can see the live site here https://sydneychick2748.github.io/Third-Party-API-Work-Day-Scheduler/
